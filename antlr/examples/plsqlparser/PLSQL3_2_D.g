...
match_string
	:	QUOTED_STRING 
	;
keyA                             : {toUpper(input.LT(1).getText)== "A"}? ID;
keyAUTOMATIC                     : {toUpper(input.LT(1).getText)== "AUTOMATIC"}? ID;
keyCOUNT                         : {toUpper(input.LT(1).getText)== "COUNT"}? ID;
keyCROSS                         : {toUpper(input.LT(1).getText)== "CROSS"}? ID;
keyCUBE                          : {toUpper(input.LT(1).getText)== "CUBE"}? ID;
keyCURRENT_OF                    : {toUpper(input.LT(1).getText)== "CURRENT_OF"}? ID;
keyDAY                           : {toUpper(input.LT(1).getText)== "DAY"}? ID;
keyDBTIMEZONE                    : {toUpper(input.LT(1).getText)== "DBTIMEZONE"}? ID;
keyDECREMENT                     : {toUpper(input.LT(1).getText)== "DECREMENT"}? ID;
keyDIMENSION                     : {toUpper(input.LT(1).getText)== "DIMENSION"}? ID;
keyEMPTY                         : {toUpper(input.LT(1).getText)== "EMPTY"}? ID;
keyEQUALS_PATH                   : {toUpper(input.LT(1).getText)== "EQUALS_PATH"}? ID;
keyESCAPE                        : {toUpper(input.LT(1).getText)== "ESCAPE"}? ID;
keyFIRST                         : {toUpper(input.LT(1).getText)== "FIRST"}? ID;
keyFULL                          : {toUpper(input.LT(1).getText)== "FULL"}? ID;
keyGROUPING                      : {toUpper(input.LT(1).getText)== "GROUPING"}? ID;
keyIGNORE                        : {toUpper(input.LT(1).getText)== "IGNORE"}? ID;
keyINCREMENT                     : {toUpper(input.LT(1).getText)== "INCREMENT"}? ID;
keyINFINITE                      : {toUpper(input.LT(1).getText)== "INFINITE"}? ID;
keyINNER                         : {toUpper(input.LT(1).getText)== "INNER"}? ID;
keyINTERVAL                      : {toUpper(input.LT(1).getText)== "INTERVAL"}? ID;
keyITERATE                       : {toUpper(input.LT(1).getText)== "ITERATE"}? ID;
keyJOIN                          : {toUpper(input.LT(1).getText)== "JOIN"}? ID;
keyKEEP                          : {toUpper(input.LT(1).getText)== "KEEP"}? ID;
keyLAST                          : {toUpper(input.LT(1).getText)== "LAST"}? ID;
keyLEFT                          : {toUpper(input.LT(1).getText)== "LEFT"}? ID;
keyLIKE2                         : {toUpper(input.LT(1).getText)== "LIKE2"}? ID;
keyLIKE4                         : {toUpper(input.LT(1).getText)== "LIKE4"}? ID;
keyLIKEC                         : {toUpper(input.LT(1).getText)== "LIKEC"}? ID;
keyLOCAL                         : {toUpper(input.LT(1).getText)== "LOCAL"}? ID;
keyMAIN                          : {toUpper(input.LT(1).getText)== "MAIN"}? ID;
keyMEASURES                      : {toUpper(input.LT(1).getText)== "MEASURES"}? ID;
keyMEMBER                        : {toUpper(input.LT(1).getText)== "MEMBER"}? ID;
keyMODEL                         : {toUpper(input.LT(1).getText)== "MODEL"}? ID;
keyMONTH                         : {toUpper(input.LT(1).getText)== "MONTH"}? ID;
keyNAN                           : {toUpper(input.LT(1).getText)== "NAN"}? ID;
keyNATURAL                       : {toUpper(input.LT(1).getText)== "NATURAL"}? ID;
keyNAV                           : {toUpper(input.LT(1).getText)== "NAV"}? ID;
keyNOCYCLE                       : {toUpper(input.LT(1).getText)== "NOCYCLE"}? ID;
keyNULLS                         : {toUpper(input.LT(1).getText)== "NULLS"}? ID;
keyONLY                          : {toUpper(input.LT(1).getText)== "ONLY"}? ID;
keyOUTER                         : {toUpper(input.LT(1).getText)== "OUTER"}? ID;
keyPARTITION                     : {toUpper(input.LT(1).getText)== "PARTITION"}? ID;
keyPRECISION                     : {toUpper(input.LT(1).getText)== "PRECISION"}? ID;
keyPRESENT                       : {toUpper(input.LT(1).getText)== "PRESENT"}? ID;
keyREFERENCE                     : {toUpper(input.LT(1).getText)== "REFERENCE"}? ID;
keyREGEXP_LIKE                   : {toUpper(input.LT(1).getText)== "REGEXP_LIKE"}? ID;
//keyRETURN                        : {toUpper(input.LT(1).getText)== "RETURN"}? ID;
keyRIGHT                         : {toUpper(input.LT(1).getText)== "RIGHT"}? ID;
keyROLLUP                        : {toUpper(input.LT(1).getText)== "ROLLUP"}? ID;
keyRULES                         : {toUpper(input.LT(1).getText)== "RULES"}? ID;
keySECOND                        : {toUpper(input.LT(1).getText)== "SECOND"}? ID;
keySECONDS                       : {toUpper(input.LT(1).getText)== "SECONDS"}? ID;
keySEQUENTIAL                    : {toUpper(input.LT(1).getText)== "SEQUENTIAL"}? ID;
keySESSIONTIMEZONE               : {toUpper(input.LT(1).getText)== "SESSIONTIMEZONE"}? ID;
keySETS                          : {toUpper(input.LT(1).getText)== "SETS"}? ID;
keySIBLINGS                      : {toUpper(input.LT(1).getText)== "SIBLINGS"}? ID;
keySINGLE                        : {toUpper(input.LT(1).getText)== "SINGLE"}? ID;
keySOME                          : {toUpper(input.LT(1).getText)== "SOME"}? ID;
keySUBMULTISET                   : {toUpper(input.LT(1).getText)== "SUBMULTISET"}? ID;
keyTIME                          : {toUpper(input.LT(1).getText)== "TIME"}? ID;
keyTIMESTAMP                     : {toUpper(input.LT(1).getText)== "TIMESTAMP"}? ID;
keyTHE                           : {toUpper(input.LT(1).getText)== "THE"}? ID;
keyUNDER_PATH                    : {toUpper(input.LT(1).getText)== "UNDER_PATH"}? ID;
keyUNTIL                         : {toUpper(input.LT(1).getText)== "UNTIL"}? ID;
keyUPDATED                       : {toUpper(input.LT(1).getText)== "UPDATED"}? ID;
keyUPSERT                        : {toUpper(input.LT(1).getText)== "UPSERT"}? ID;
keyWAIT                          : {toUpper(input.LT(1).getText)== "WAIT"}? ID;
keyYEAR                          : {toUpper(input.LT(1).getText)== "YEAR"}? ID;
keyZONE                          : {toUpper(input.LT(1).getText)== "ZONE"}? ID;

keyARRAY                         : {toUpper(input.LT(1).getText)== "ARRAY"}? ID;
keyAUTONOMOUS_TRANSACTION        : {toUpper(input.LT(1).getText)== "AUTONOMOUS_TRANSACTION"}? ID;
keyBODY                          : {toUpper(input.LT(1).getText)== "BODY"}? ID;
keyBUILTIN                       : {toUpper(input.LT(1).getText)== "BUILTIN"}? ID;
keyBULK                          : {toUpper(input.LT(1).getText)== "BULK"}? ID;
keyBYTE                          : {toUpper(input.LT(1).getText)== "BYTE"}? ID;
keyCLOSE                         : {toUpper(input.LT(1).getText)== "CLOSE"}? ID;
keyCOLLECT                       : {toUpper(input.LT(1).getText)== "COLLECT"}? ID;
keyCURSOR                        : {toUpper(input.LT(1).getText)== "CURSOR"}? ID;
keyELSIF                         : 'ELSIF'; //{toUpper(input.LT(1).getText)== "ELSIF"}? ID;
keyEXCEPTION_INIT                : {toUpper(input.LT(1).getText)== "EXCEPTION_INIT"}? ID;
keyEXIT                          : {toUpper(input.LT(1).getText)== "EXIT"}? ID;
keyFIPSFLAG                      : {toUpper(input.LT(1).getText)== "FIPSFLAG"}? ID;
keyFUNCTION                      : 'FUNCTION'; //{toUpper(input.LT(1).getText)== "FUNCTION"}? ID;
keyINTERFACE                     : {toUpper(input.LT(1).getText)== "INTERFACE"}? ID;
keyLOOP                          : 'LOOP'; //{toUpper(input.LT(1).getText)== "LOOP"}? ID;
keyNEW                           : {toUpper(input.LT(1).getText)== "NEW"}? ID;
keyNEW_NAMES                     : {toUpper(input.LT(1).getText)== "NEW_NAMES"}? ID;
keyOPEN                          : {toUpper(input.LT(1).getText)== "OPEN"}? ID;
keyOUT                           : 'OUT'; //{toUpper(input.LT(1).getText)== "OUT"}? ID;
keyPACKAGE                       : 'PACKAGE'; //{toUpper(input.LT(1).getText)== "PACKAGE"}? ID;
keyPRAGMA                        : 'PRAGMA'; //{toUpper(input.LT(1).getText)== "PRAGMA"}? ID;
keyRAISE                         : 'RAISE'; //{toUpper(input.LT(1).getText)== "RAISE"}? ID;
keyRANGE                         : {toUpper(input.LT(1).getText)== "RANGE"}? ID;
keyREAD                          : {toUpper(input.LT(1).getText)== "READ"}? ID;
keyRECORD                        : 'RECORD'; //{toUpper(input.LT(1).getText)== "RECORD"}? ID;
keyREF                           : {toUpper(input.LT(1).getText)== "REF"}? ID;
keyREPLACE                       : {toUpper(input.LT(1).getText)== "REPLACE"}? ID;
keyRESTRICT_REFERENCES           : {toUpper(input.LT(1).getText)== "RESTRICT_REFERENCES"}? ID;
keyRETURN                        : 'RETURN'; //{toUpper(input.LT(1).getText)== "RETURN"}? ID;
keyRETURNING                     : 'RETURNING'; //{toUpper(input.LT(1).getText)== "RETURNING"}? ID;
keyREVERSE                       : {toUpper(input.LT(1).getText)== "REVERSE"}? ID;
keyROLLBACK                      : 'ROLLBACK'; //{toUpper(input.LT(1).getText)== "ROLLBACK"}? ID;
keySERIALLY_REUSABLE             : {toUpper(input.LT(1).getText)== "SERIALLY_REUSABLE"}? ID;
keySUBTYPE                       : {toUpper(input.LT(1).getText)== "SUBTYPE"}? ID;
keyTRANSACTION                   : {toUpper(input.LT(1).getText)== "TRANSACTION"}? ID;
keyTYPE                          : {toUpper(input.LT(1).getText)== "TYPE"}? ID;
keyUSING                         : {toUpper(input.LT(1).getText)== "USING"}? ID;
keyVARRAY                        : {toUpper(input.LT(1).getText)== "VARRAY"}? ID;
keyVARYING                      : {toUpper(input.LT(1).getText)== "VARYING"}? ID;
keyWHILE                         : 'WHILE'; //{toUpper(input.LT(1).getText)== "WHILE"}? ID;
keyWORK                          : {toUpper(input.LT(1).getText)== "WORK"}? ID;
...
/* JAVA Syntax */        
 		( { input.LT(1) != $delimiter.text[0] || ( input.LT(1) == $delimiter.text[0] && input.LT(2) != '\'') }? => . )*
 		( { input.LT(1) == $delimiter.text[0] && input.LT(2) == '\'' }? => . ) QUOTE
/* C Syntax */ 
	//	( { input.LA(1) != $delimiter.getText().chars[0] ||input. LA(2) != '\'' }? => . )*
//		( { input.LA(1) == $delimiter.getText().chars[0] && input.LA(2) == '\'' }? => . ) QUOTE
